...
export default function Home() {
  ...
  const featuredGames = [
    ...
    },
    {
      ...
      maxPrize: 'R$ 30.000,00',
      price: 'R$ 50,00',
      icon: 'https://i.postimg.cc/KYrwWvNC/imgi-78-Luxo-Raspa-vel.png'
    },
    {
      id: 'casa-dos-sonhos',
      title: 'Casa Dos Sonhos',
      banner: 'CASA DOS SONHOS',
      maxPrize: 'R$ 60.000,00',
      price: 'R$ 100,00',
      icon: 'https://i.postimg.cc/j2C1C6br/imgi-79-Casa-dos-Sonhos.png'
    }
  ];
