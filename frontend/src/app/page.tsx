    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-yellow-300 flex flex-col items-center font-sans">
      ...
      <header className="w-full flex justify-between items-center p-4 bg-white/80 shadow-md">
        ...
        <nav className="flex gap-4">
          ...
          <Link href="/login" className="text-yellow-700 font-semibold hover:underline">Entrar</Link>
        </nav>
      </header>
      ...
      <section className="flex flex-col items-center justify-center flex-1 w-full max-w-2xl text-center py-12">
        ...
        <Link href="/login" className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-full text-lg shadow-lg transition">Quero jogar agora</Link>
      </section>
      ...
      <section id="login" className="w-full max-w-md bg-white/90 rounded-xl shadow-lg p-8 mb-12 flex flex-col items-center">
        ...
        <div className="flex flex-col gap-4 w-full">
          <Link href="/login" className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-6 rounded transition text-center">
            Entrar
          </Link>
          <Link href="/cadastro" className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded transition text-center">
            Cadastrar
          </Link>
        </div>
        <p className="mt-4 text-sm text-yellow-800">
          Já tem conta? <Link href="/login" className="underline font-semibold">Entrar</Link> | 
          Não tem conta? <Link href="/cadastro" className="underline font-semibold">Cadastre-se</Link>
        </p>
      </section>
